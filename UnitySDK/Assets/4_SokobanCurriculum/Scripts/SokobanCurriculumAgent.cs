...
public class SokobanCurriculumAgent : Agent
{
    [Header("Specific to Sokoban")]
    private SokobanCurriculumAcademy academy;
    ...
    {
        academy = FindObjectOfType(typeof(SokobanCurriculumAcademy)) as SokobanCurriculumAcademy;
    }
